...
Bot.Log("手牌数" + board.Hand.Count);
 int shejidashi=board.Hand.Count(x => x.Template.Id == Card.Cards.SW_322t4)+board.FriendGraveyard.Count(card => CardTemplate.LoadFromId(card).Id == Card.Cards.SW_322t4);
 Bot.Log("射击大师塔维什"+shejidashi);//射击大师塔维什  SW_322t4 

#endregion

#region 击伤猎物 BAR_801
if(board.HasCardInHand(Card.Cards.BAR_801)){
p.CastSpellsModifiers.AddOrUpdate(Card.Cards.BAR_801, new Modifier(-20));
Bot.Log("击伤猎物 -20");
}
#endregion

#region 奥术射击 CORE_DS1_185
if(board.HasCardInHand(Card.Cards.CORE_DS1_185)){
p.CastSpellsModifiers.AddOrUpdate(Card.Cards.CORE_DS1_185, new Modifier(-20));
Bot.Log("奥术射击 -20");
}
#endregion

#region 奥秘图纸 BOT_402
if(board.HasCardInHand(Card.Cards.BOT_402)
&&shejidashi>=1){
p.CastSpellsModifiers.AddOrUpdate(Card.Cards.BOT_402, new Modifier(-20));
Bot.Log("奥秘图纸 -20");
}else{
p.CastSpellsModifiers.AddOrUpdate(Card.Cards.BOT_402, new Modifier(150));
}
#endregion

#region 急速射击 DAL_373
if(board.HasCardInHand(Card.Cards.DAL_373)){
p.CastSpellsModifiers.AddOrUpdate(Card.Cards.DAL_373, new Modifier(-20));
Bot.Log("急速射击 -20");
}
#endregion

#region 搜寻猎物 OG_061
if(board.HasCardInHand(Card.Cards.OG_061)){
p.CastSpellsModifiers.AddOrUpdate(Card.Cards.OG_061, new Modifier(-20));
Bot.Log("搜寻猎物 -20");
}
#endregion

#region 数量压制 SCH_604
if(board.HasCardInHand(Card.Cards.SCH_604)){
p.CastSpellsModifiers.AddOrUpdate(Card.Cards.SCH_604, new Modifier(-20));
Bot.Log("数量压制 -20");
}
#endregion

#region 照明弹 EX1_544 
if(board.HasCardInHand(Card.Cards.EX1_544)
&&shejidashi>=1
){
p.CastSpellsModifiers.AddOrUpdate(Card.Cards.EX1_544, new Modifier(-20));
Bot.Log("照明弹 -20");
}else{
p.CastSpellsModifiers.AddOrUpdate(Card.Cards.EX1_544, new Modifier(150));
}
#endregion

#region 猎人印记 CS2_084
if(board.HasCardInHand(Card.Cards.CS2_084)
&&shejidashi>=1){
p.CastSpellsModifiers.AddOrUpdate(Card.Cards.CS2_084, new Modifier(-20));
Bot.Log("猎人印记 -20");
}else{
p.CastSpellsModifiers.AddOrUpdate(Card.Cards.CS2_084, new Modifier(150));
}
#endregion

#region 病毒增援 DRG_255
if(board.HasCardInHand(Card.Cards.DRG_255)){
p.CastSpellsModifiers.AddOrUpdate(Card.Cards.DRG_255, new Modifier(-20));
Bot.Log("病毒增援 -20");
}
#endregion
...
p.CastSpellsModifiers.AddOrUpdate(Card.Cards.CORE_DS1_184, new Modifier(-20));
Bot.Log("追踪术 -20");
}else{
p.CastSpellsModifiers.AddOrUpdate(Card.Cards.CORE_DS1_184, new Modifier(150));
}
#endregion

#region 寒光智者 EX1_050
if(board.HasCardInHand(Card.Cards.EX1_050)
&&shejidashi>=1
){
p.CastSpellsModifiers.AddOrUpdate(Card.Cards.EX1_050, new Modifier(-20));
Bot.Log("追踪术 -20");
}else{
p.CastSpellsModifiers.AddOrUpdate(Card.Cards.EX1_050, new Modifier(150));
}
#endregion

#region 瞄准射击 SW_321
if(board.HasCardInHand(Card.Cards.SW_321)
){
p.CastSpellsModifiers.AddOrUpdate(Card.Cards.SW_321, new Modifier(-20));
Bot.Log("追踪术 -20");
}
#endregion

#region 射击大师塔维什 SW_322t4 
if(board.HasCardInHand(Card.Cards.SW_322t4)
){
p.CastSpellsModifiers.AddOrUpdate(Card.Cards.SW_322t4, new Modifier(-9999));
p.PlayOrderModifiers.AddOrUpdate(Card.Cards.SW_322t4, new Modifier(9999)); 
Bot.Log("射击大师塔维什 -9999");
}
#endregion

#region 弩炮射击  HERO_05bp2 
if(shejidashi>=1
){
  p.CastHeroPowerModifier.AddOrUpdate(Card.Cards.HERO_05bp2, new Modifier(-9999));  
  p.PlayOrderModifiers.AddOrUpdate(Card.Cards.HERO_05bp2, new Modifier(9999));
  p.CastHeroPowerModifier.AddOrUpdate(Card.Cards.HERO_05bp, new Modifier(-9999));  
  p.PlayOrderModifiers.AddOrUpdate(Card.Cards.HERO_05bp, new Modifier(9999));
  Bot.Log("弩炮射击 -9999");
}
#endregion
