...
#region 直伤卡牌 标准模式
        ...
        private static readonly Dictionary<Card.Cards, int> _spellDamagesTable = new Dictionary<Card.Cards, int>
        {
            ...
            {Card.Cards.BAR_880, 3},//定罪（等级1） Conviction (Rank 1) ID：BAR_880 
            {Card.Cards.BAR_880t, 6},//定罪（等级2） Conviction (Rank 2) ID：BAR_880t 
            {Card.Cards.BAR_880t2, 9},//定罪（等级3） Conviction (Rank 3) ID：BAR_880t2 
            //牧师
            //盗贼
...
#region 逝者之剑 BAR_875 
        ...
        p.WeaponsAttackModifiers.AddOrUpdate(Card.Cards.BAR_875, new Modifier(-999));
        }
#endregion
...
#region 阿达尔之手 BT_292
        ...
        {
         p.PlayOrderModifiers.AddOrUpdate(Card.Cards.BT_292, new Modifier(999));
...
#region 瓦里安，暴风城国王 SW_081
        ...
        {
          p.CastMinionsModifiers.AddOrUpdate(Card.Cards.SW_081, new Modifier(-150));
        p.PlayOrderModifiers.AddOrUpdate(Card.Cards.SW_081, new Modifier(550)); 
          Bot.Log("瓦里安，暴风城国王 -150");
        } 
#endregion
#region 圣礼骑士 BAR_873
        ...
        {
          p.CastMinionsModifiers.AddOrUpdate(Card.Cards.BAR_873, new Modifier(-88));
        p.PlayOrderModifiers.AddOrUpdate(Card.Cards.SW_081, new Modifier(999)); 
          Bot.Log("圣礼骑士 -88");
        } 
#endregion
...
#region 十字路口哨所      BAR_075
      ...
      p.CastMinionsModifiers.AddOrUpdate(Card.Cards.BAR_075, new Modifier(-50*(friendCount)));//十字路口哨所      BAR_075 
      Bot.Log("十字路口哨所"+-50*friendCount);
      }
...
#region 巴罗夫领主 Lord Barov  ID：SCH_526)
