...
#region 攻击模式和自定义 
      public ProfileParameters GetParameters(Board board)
      {
                ...
                )
            {
                ...
                Bot.Log("攻击值"+(a * 0.625 + 76.5));
            }
            else
            {
                p.GlobalAggroModifier = (int)(a * 0.625 + 113.5);
                Bot.Log("攻击值"+(a * 0.625 + 83.5));
            }	   
                     
            }else{
               p.GlobalAggroModifier = (int)(a * 0.625 + 60.5);
            }
...
#region 间谍大师斯卡布斯 SW_052t3 
      if(board.HasCardInHand(Card.Cards.SW_052t3)){
      p.CastMinionsModifiers.AddOrUpdate(Card.Cards.SW_052t3, new Modifier(-999));
      Bot.Log("间谍大师斯卡布斯"+-999);
      }
#endregion

#region 军情七处线人 SW_411 
      if(board.HasCardInHand(Card.Cards.SW_411)){
      p.CastMinionsModifiers.AddOrUpdate(Card.Cards.SW_411, new Modifier(130));
      Bot.Log("军情七处线人"+130);
      }
#endregion
