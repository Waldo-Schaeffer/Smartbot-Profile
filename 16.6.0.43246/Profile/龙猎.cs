...
namespace SmartBotProfiles
{
    ...
    public class WildSecretMage : Profile
    {
        ...
        var p = new ProfileParameters(BaseProfile.Face);
        p.DiscoverSimulationValueThresholdPercent = 10;
        
		
		//降低升级蓝龙威胁值 没必要解
        p.OnBoardBoardEnemyMinionsModifiers.AddOrUpdate(Card.Cards.DRG_270, new Modifier(70));
		
		//降低猎人113威胁值 没必要硬币解
        p.OnBoardBoardEnemyMinionsModifiers.AddOrUpdate(Card.Cards.DRG_253, new Modifier(95));
		
         
        //降低毒龙优先级
        p.CastMinionsModifiers.AddOrUpdate(Card.Cards.DRG_254, new Modifier(20));
		
		//降低精灵龙优先级
        p.CastMinionsModifiers.AddOrUpdate(Card.Cards.NEW1_023, new Modifier(100));
