...
// # 2x (1) 烈焰小鬼 Flame Imp ID：EX1_319 
    ...
    public class SMK_renwushudongwuyuan : Archetype
    {
        ...
        public List<Card.Cards> ArchetypeCardSet()
        {
            return new List<Card.Cards>()
            {
                ...
                Card.Cards.SW_084,//血缚小鬼 Bloodbound Imp ID：SW_084
                Card.Cards.BT_309,//坎雷萨德·埃伯洛克 Kanrethad Ebonlocke ID：BT_309 
                Card.Cards.ICC_055,//吸取灵魂 Drain Soul ID：ICC_055
                Card.Cards.BAR_745,//乱齿土狼 Hecklefang Hyena ID：BAR_745 
                ...
                Card.Cards.DMF_111,//摇滚堕落者 Man'ari Mosher ID：DMF_111
                Card.Cards.DMF_066,// 小刀商贩 Knife Vendor ID：DMF_066 
